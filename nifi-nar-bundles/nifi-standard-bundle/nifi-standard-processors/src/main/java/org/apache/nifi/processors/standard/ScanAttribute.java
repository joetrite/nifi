...
public class ScanAttribute extends AbstractProcessor {
    ...
    private volatile Map<String,String> dictionaryTermMatches = null;
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        for  (FlowFile flowFile : flowFiles) {
            ...
            final Relationship relationship = (((matched.size() == (attributeNameMatches.size() * 3) && matchAll) || (matched.size() > 0 && !matchAll)) || (attributePattern == null && attributeNameMatches.size() == 0)) ? REL_MATCHED : REL_UNMATCHED;
    ...
    private Map<String,String> matchAny(final FlowFile flowFile, final Pattern attributePattern, final Map<String,String> dictionary) {    	
    	dictionaryTermMatches = new HashMap<String,String>();
